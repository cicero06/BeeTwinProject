          ...
          <ul>
            <li className="border-b border-gray-200 dark:border-gray-700/60 last:border-0">
              <Link
                ...
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <span className="block text-sm mb-2">📣 <span className="font-medium text-gray-800 dark:text-gray-100">{/* replace the notification dynamically */} Notification</span>
                </span>
                <span>
                  {/* replace the details of notification */}notification details

                </span>

                <span className="block text-xs font-medium text-gray-400 dark:text-gray-500">sep 12, 2025</span>
              </Link>
            </li>
          </ul>
        </div>
